  ...
  const deleteCompany = async id => {
    ...
    try {
      ...
      let res = await axios.post(
        `/campaign/delete?campaign_id=${id}&subuser=${
        ...
        {!reklamodatel && (
          <div>
            ...
            {props.item.status !== "draft" && (
              <MenuItem
                component={Link}
                to={`/campaign/view/${props.item.id}#stat`}
                classes={{ root: classes.menuItem }}
              >
                Настройки
              </MenuItem>
            ...
            {props.item.status !== "finished" && props.item.status !== "draft" && (
              <div>
                <Divider />
                <MenuItem
                  classes={{ root: classes.menuItem }}
                  onClick={() => preDelete(props)}
                >
                  Остановить
                </MenuItem>
              </div>
