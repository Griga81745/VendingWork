    ...
    <div className="kt-portlet">
      <div className="kt-portlet__head">
        <div className="kt-portlet__head-label">
          <h3 className="kt-portlet__head-title">Статистика показов</h3>
        </div>
      ...
      <div className="kt-portlet__body">
        <Box style={{ overflow: "auto" }}>
          ...
          >
            ...
            <Typography>Название рекламной кампании</Typography>
          </Box>
          {props.mediaInfo.mediaplan_shows &&
            props.mediaInfo.mediaplan_shows.map(media => (
              <Box classes={{ root: classes.tableRow }}>
                <Box style={{ textAlign: "start" }}>{media.date_time}</Box>
                <Box>{media.dur}</Box>
                <Box>Заставка</Box>
              </Box>
            ))}
